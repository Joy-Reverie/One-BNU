...
private data class AnnouncementItem(val number: String, val text: String, val important: Boolean = false)

private val ITEMS = listOf(
    AnnouncementItem(
        "1",
        "登录或数据同步异常时，请留意 GitHub 发布页，或前往“设置 - 版本”检查更新，并及时升级至最新版本。首次同步数据建议优先使用校园网；同步完成后，数据会缓存到本地，后续可使用流量或在无网络环境下查看已同步内容。",
    ),
    AnnouncementItem(
        "2",
    ...
    AnnouncementItem(
        "3",
        "如需开启上课提醒或日程提醒，请按应用内引导授予通知权限；也可在桌面长按 One BNU，进入“应用设置 - 通知管理”并开启通知。在下方“通知类别”中，可按需求设置铃声、震动、悬浮通知及锁屏显示等选项。",
    ),
    AnnouncementItem(
        "4",
    ...
    AnnouncementItem(
        "!",
        "请认准可信来源，最可靠的是 GitHub 仓库：https://github.com/Joy-Reverie/One-BNU/releases。其他来源安装包存在可能使个人信息遭到泄露！",
        important = true,
    ),
)
...
@Composable
private fun AnnouncementRow(item: AnnouncementItem) {
