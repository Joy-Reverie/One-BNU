...
class CreditCategoryStore(context: Context, campus: Campus = Campus.BEIJING) {
    private val prefs = context.getSharedPreferences(
        if (campus == Campus.BEIJING) "onebnu_credit_categories"
        else "onebnu_credit_categories_${campus.storageKey}",
