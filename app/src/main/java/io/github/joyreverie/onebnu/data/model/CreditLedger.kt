...
object CategoryRules {
    ...
    // 「理论与实践」「伦理」「体育」单独出现时太宽：机器学习理论与实践、生命伦理学、体育社会学都是专业课。
    private val PUBLIC_REQUIRED_NAME = Regex(
        "英语|外语|思想|^理论与实践|社会主义.*理论与实践|马克思|当代科技|社会思潮|自然辩证法|教育改革|" +
            "工程伦理|学术伦理|科研伦理|学术规范|学术道德|中国特色|政治|形势与政策|国家安全教育",
    )
    private val PUBLIC_ELECTIVE_NAME = Regex(
        "公共选修|通识选修|全校选修|体育(?![学史经管心教产新哲社科理法概])|美育|艺术鉴赏|心理健康|创新创业|" +
            "劳动教育|就业指导|职业发展|信息素养|第二外语",
    )
